...
namespace WealthWave.Test
{
    public class ChequingAccountTests
    {
        ...
        [Theory]
        [InlineData(-149999, 150000, -299999)]
        public void ChequingAccountException_WithdrawTransaction_WithdrawRequestedAmount(double testValue, double defaultBalance, double expectedOutput)
        {
            // Arrange varables, classes mocks
            var userAccount = new ChequingAccount(defaultBalance);
            string message;
