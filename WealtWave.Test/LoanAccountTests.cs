...
namespace WealthWave.Test
{
    public class LoanAccountTests
    {
        ...
        [Fact]
        public void LoanAccountException_ApplyForLoan_GetApprovedForLoanAmount()
        {
            // Arrange varables, classes mocks
            int amountToApplyFor = -10000;
            var userAccount = new LoanAccount();
        ...
        [Theory]
        [InlineData(-25000, 26525, 26526)]
        public void LoanAccountException_InterestCalculation_NoticeInterestAppliedToLoan(double testValue, double expectedOutput, double upperRangeOfOutput)
        {
            // Arrange varables, classes mocks
            var userAccount = new LoanAccount();
            string message;
        ...
        [Theory]
        [InlineData(-25000, 25000)]
        public void LoanAccountException_WithdrawTransaction_WithdrawRequestedAmount(double testValue, double expectedOutput)
        {
            // Arrange varables, classes mocks
            var userAccount = new LoanAccount();
            string message;
        ...
        [Theory]
        [InlineData(-25000, 0)]
        public void LoanAccountException_DebtCollector_CollectUserDebt(double testValue, double expectedOutput)
        {
            // Arrange varables, classes mocks
            var userAccount = new LoanAccount();
            string message;
        ...
        [Theory]
        [InlineData(-1000, 25000, 25464, 25465)]
        public void LoanAccountException_DepositTransaction_DepositRequestedAmount(double testValue, double requestedLoan, double expectedOutput, double upperRangeOfOutput)
        {
            // Arrange varables, classes mocks
            var userAccount = new LoanAccount();
            string message;
