...
namespace WealthWave
{
    ...
    *              to be applied to a more specialized account type, which is itself the SavingsAccount. It inherits from the base class, Account.
    ...
    */
    internal class SavingsAccount : Account
    {
        ...
        * Returns:     Void.
        */
        public override void DepositTransaction(double newDepositAmount)
        {
